 ...
 *
 * Niyə helper?
 * - `accessToken`, `userWordId`, `sourceText` kimi field-lərin həqiqətən string olduğunu yoxlayırıq.
 */
 ...
 *
 * Niyə helper?
 * - `isFavorite`, `isCorrect` kimi field-lərin boolean olduğunu yoxlayırıq.
 */
 ...
 *
 * Niyə helper?
 * - Practice item içində review statistikalarının number olduğunu yoxlayırıq.
 */
